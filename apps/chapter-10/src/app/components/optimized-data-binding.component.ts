...
export default class OptimizedDataBindingComponent {
  ...
  calculateTotal(num: number) {
    console.log(`Calculate Total directly from the component`)
    let num1 = 0
    let num2 = 1
    let sum
    let i = 0
